...
@Component({
  selector: 'app-side-by-side-visualization',
  templateUrl: './side-by-side-visualization.component.html',
  styleUrls: ['./side-by-side-visualization.component.css'],
})
export class SideBySideVisualizationComponent implements OnInit {
  ...
  form = this.formBuilder.group({
    ...
    imports: [false, [Validators.required]],
    sonarQube: [false, [Validators.required]],
    symbols: [false, [Validators.required]],
    bookmarkName: [''],
  });
  repositories: string[] = [];
  ...
  submitForm() {
    ...
    const imports = this.form.controls.imports.value;
    const sonarQube = this.form.controls.sonarQube.value;
    const symbols = this.form.controls.symbols.value;
    const [repositoryLeft, repositoryRight] =
      this.form.controls.repositories.value;
    ...
    this.dashboardsApi
      .getSideBySide({
        from: dateStart,
        to: dateEnd,
        repository: repositoryLeft,
        repository2: repositoryRight,
        panels: {
          imports,
          sonarQube,
          symbols,
